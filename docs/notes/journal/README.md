...
> **The newest entry is
> [`2026-09-17-code-as-tutor.md`](2026-09-17-code-as-tutor.md)**: Code becomes the tutor on top
> of existing material (Khan Academy, OpenStax, Galaxy Training), M0 paused after part 2, and an
> open question on exams. Four entries share this date; read this one first, then
> [part 2's](2026-09-17-m0-part-2-django-project.md) for where M0 stands.
