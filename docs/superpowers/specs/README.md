...
| [2026-09-17 — M0 part 1: workspace and purity guard](2026-09-17-m0-workspace-and-purity-guard-design.md) | design, awaiting approval | Python 3.14, the uv workspace, pytest, ruff, mypy strict, the static and runtime purity guards, the link check, CI |
