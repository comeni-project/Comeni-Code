...
| [2026-09-17 — M0 part 5: the web toolchain](2026-09-17-m0-web-toolchain-design.md) | agreed | `apps/web` on npm and Node 24, Vite 8, React 19, TypeScript 7 strict, Biome 2.5 (preset recommended, a11y canary), vitest 5 with jsdom, a parallel `web` CI job |
