...
| [2026-09-17 — M0 part 3: the Ninja API and health](2026-09-17-m0-ninja-api-and-health-design.md) | agreed | one `NinjaAPI` at `/api/`, `/api/health` (200/503, never 500), docs page from Ninja's bundled files via WhiteNoise, the committed schema kept current by a test |
