...
| [2026-09-17 — M0 part 2: the Django project boots](2026-09-17-m0-django-project-design.md) | agreed | `apps/api` as `code_api`, pydantic-settings with `CODE_*` variables, the custom user model, Postgres 18 in Compose, pytest-django and django-stubs, the OpenAPI constraint on part 3 |
